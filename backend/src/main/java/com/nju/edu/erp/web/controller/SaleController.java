...
import com.nju.edu.erp.model.vo.SaleSheetWithPromotionVO;
...
public class SaleController {
    ...
    public Response makePurchaseOrder(UserVO userVO, @RequestBody SaleSheetWithPromotionVO vo)  {
        SaleSheetVO saleSheetVO = new SaleSheetVO();
        BeanUtils.copyProperties(vo, saleSheetVO);
        Integer promotionId = vo.getPromotionId();
        saleService.makeSaleSheet(userVO, saleSheetVO, promotionId);
