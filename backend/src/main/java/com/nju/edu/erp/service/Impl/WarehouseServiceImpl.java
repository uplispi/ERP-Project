...
//            warehouseDao.deductQuantity(warehousePO);
    ...
    public List<WarehouseIODetailPO> getWarehouseIODetailByTime(String beginDateStr,String endDateStr) {
         ...
         *
         */
        Date beginDate = dateFormat(beginDateStr);
        Date endDate = dateFormat(endDateStr);
        if(beginDate.after(endDate)){
            return null;
        }
        List<WarehouseIODetailPO> warehouseIODetailPOList = warehouseInputSheetDao.getWarehouseIODetailByTime(beginDate, endDate);

        return warehouseIODetailPOList;
    }
    ...
    public int getWarehouseInputProductQuantityByTime(String beginDateStr,String endDateStr){
        ...
        Integer result = warehouseInputSheetDao.getWarehouseInputProductQuantityByTime(beginDate, endDate);
    ...
    public int getWarehouseOutProductQuantityByTime(String beginDateStr,String endDateStr){
        ...
        Integer result = warehouseOutputSheetDao.getWarehouseOutputProductQuantityByTime(beginDate, endDate);
    ...
    /**
     * 将“yyyy-MM-dd HH:mm:ss”日期字符串格式化为Date对象
     * @param str
     * @return
     */
