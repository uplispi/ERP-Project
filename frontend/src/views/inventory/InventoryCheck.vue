  ...
  <Layout>
    ...
    <div class="table-body">
      ...
      >
        ...
        <el-table-column prop="name" label="商品名称" min-width="12%">
        </el-table-column>
...
import { getWarehouseCounting, downloadWarehouseCounting } from "@/network/warehouse";
