...
<Layout>
  ...
  <el-button v-if="permitted()" type="primary" size="medium" @click="dialogVisible = true">制定销售退货单</el-button>
  <div class="body">
...
import {createSaleReturn, getAllSale, getAllSaleReturn} from "@/network/sale";
export default {
  name: 'SaleReturnView',
  components: {
    Layout,
  ...
  data(){
    return{
      ...
      saleReturnList: [],
      pendingLevel1List: [],   // 待一级审批
      pendingLevel2List: [],   // 待二级审批
      successList: [],         // 审批成功
      failureList: [],         // 审批失败
      saleReturnForm: {
        // saleSheetId: '',    // 销售退货单对应的销售单
